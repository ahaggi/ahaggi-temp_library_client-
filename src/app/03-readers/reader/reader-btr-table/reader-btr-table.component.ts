...
import { Payload, sharedTableCellButton, sharedTableCellIcon, sharedTableCellImg, sharedTableCellIndex, sharedTableCellKind, sharedTableCellText } from 'src/app/0-shared-components/shared-table/shared-table.component';
import { deleteBooksToReadersMut } from 'src/app/util/mutationsDef';
import { getBookByIDQry, getReaderByIDQry } from 'src/app/util/queriesDef';
import { formatDateAndTime, ImgCategory, loadImageFromStorage } from 'src/app/util/util';
...
export class ReaderBtrTableComponent implements OnInit {
  ...
  deleteElm(id) {
    ...
    this.apollo.mutate({
      ...
      .subscribe((v: any) => {
        console.log(v.data.deleteBooksToReaders.id)
      })
  }
